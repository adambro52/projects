...
path = os.path.normpath('C:/Users/A-dizzle/PycharmProjects/GANs/GANGogh/small_images')
...
styles = {
          ...
          # 'genre-painting': 0, #14997,
          # 'landscape': 0, #15000,
          'marina': 1800,
          # 'mythological-painting': 0, #2099,
          # 'nude-painting-nu': 0, #3000,
          'portrait': 14999,
          # 'religious-painting': 0, #8399,
          # 'still-life': 0, #2996,



          # 'symbolic-painting': 0, #2999
          }
        ...
        while True:
            ...
            for style in styles:
                ...
                for i in range(class_batch):
                    ...
                    t0=time.time()
                    image = scipy.misc.imread(os.path.normpath("{}/{}/{}.png".format(path, style, str(curr))),mode='RGB')
