...
FlashPhotoApp::FlashPhotoApp(int width, int height,
  ...
  i_editor.set_pixel_buffer(current_buffer_);
}
...
bool FlashPhotoApp::can_undo() { return i_editor.can_undo(); }

bool FlashPhotoApp::can_redo() { return i_editor.can_redo(); }

void FlashPhotoApp::Undo() { i_editor.Undo(); }

void FlashPhotoApp::Redo() { i_editor.Redo(); }

void FlashPhotoApp::SaveStateForPossibleUndo() {
  i_editor.SaveStateForPossibleUndo();
}

PixelBuffer *FlashPhotoApp::pixel_buffer() { return i_editor.pixel_buffer(); }
